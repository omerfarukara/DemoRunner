			...
			cameraScrollPosition = GUILayout.BeginScrollView(cameraScrollPosition, GUILayout.ExpandHeight(true));
				...
				P3dHelper.BeginLabelWidth(100);
					...
					EditorGUI.BeginDisabledGroup(true);
						EditorGUILayout.TextField("Paint", "Left Click + Drag", EditorStyles.popup);
						EditorGUILayout.TextField("Rotate", "Right Click + Drag", EditorStyles.popup);
						EditorGUILayout.TextField("Pan", "Middle Click + Drag", EditorStyles.popup);
